    ...
    <div class="page-info-section set-bg">
		<div class="ccontainer">
			<div class="site-breadcrumb">
                ...
                <a href="#">Cadastro Feira</a>
			</div>
		</div>
	</div>        <!-- Início dos serviços (Postagens) -->
    <section class="services">
        <div class="container">
            <div class="title text-center">
                <h1 class="title-blue">Cadastro da Feira</h1>
                <a style="center" href="ver_feira.php" class="btn btn-purple" style="">Ver Feiras</a>

            </div>
            <div class="container">
    
            <form action="cadastro_feira2.php" enctype="multipart/form-data" method="post">
  ...
  <div class="form-row">
   <div class="form-group col-md-6">
     ...
     <div class="form-group col-md-6">
      ...
      <input class="form-control" name="setor" type="text" id="setor" >
    </div>
  </div>
  <div class="form-row">
    <div class="form-group col-md-6">
      <label for="inputEmail4">Realizador da Feira:</label>
      <input class="form-control" name="realizador" type="text" id="realizador" >
    </div>
    <div class="form-group col-md-6">
      <label for="inputEmail4">Site da Feira:</label>
...
<div class="form-row">
    ...
    <br>
    <textarea class="form-control" name="descricao" cols="5" rows="8" placeholder="Limite 500 caracteres" maxlength="500"></textarea>
    </div>
    <div class="form-group col-md-6">
    <label for="inputEmail4">Contato:</label>
    <br>
    <textarea class="form-control" name="contato" cols="5" rows="8" placeholder="Email, telefone, endereço etc" maxlength="500"></textarea>
    </div>
    <div class="form-row">
    <div class="form-group col-md-6">
    <label for="inputEmail4">Capa da Feira:</label></br>
    <p><input type="file" id="capa" name="capa"></br></p>
    </div>
</div>
    </div>
</div>

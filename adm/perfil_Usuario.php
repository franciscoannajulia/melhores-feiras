...
<body>
    ...
    <section class="services">
        <div class="container">
            <div class="title text-center">
                <h2 class="title-blue">Minha Conta</h2>
            </div> 
           
        </div>
        <div class="container">
        <p>Código: <?php echo $linha["CodAdmin"]?>.<br/></p>
        <p>Nome:  <?php echo $linha["NomeAdmin"]?>.<br/></p>
        <p>Email:  <?php echo $linha["Email"]?>.<br/></p>
                <p>Login:  <?php echo $linha["Login"]?>.<br/></p>
                <p>Senha:  <?php echo $linha["Senha"]?>.<br/></p>
                <div class="title text-center">
                <a class="botao botao-info" href="alterar_Usuario.php?id=<?php echo $linha["CodAdmin"]?>" role="button">Alterar</a>
 ...
 <!-- Modal -->
    <div class="modal fade" id="Apagar" role="dialog">
            ...
            <form id="confirmando" action="apagar_Usuario.php" method="post">

...
?>
    ...
    <section class="services">
        ...
        ?>  
                <tbody>
                    <tr> 
                        <td scope="row"><?php echo $linha["CodFeira"]?></td>
                        <td scope="row">
                        <img class="capa" src="../<?php echo $linha["Capa"]?>">
                        <?php echo $linha["NomeFeira"]?></td>
                        <td scope="row"><?php echo $linha["Estado"]?></td>
                        <td scope="row"><?php echo $linha["Cidade"]?></td>
                        <td scope="row"><?php echo date('d/m/Y', strtotime($DataInicio))?> à <?php echo date('d/m/Y', strtotime($DataFim))?></td>
                        <td scope="row"><?php echo $linha["Setor"]?></td>
                        <td scope="row"><a class="botao botao-success" href="detalhe_feira.php?id=<?php echo $CodFeira?>">Ver</a>
                        <a class="botao botao-info" href="alterar_feira.php?id=<?php echo $CodFeira?>">Editar</a>
    ...
    <!-- Fim dos serviços (Postagens) -->
            ...
            <form id="confirmando" action="apagar_feira.php?id=<?php echo $CodFeira?>" method="post">
            <p>Para excluir, confirme o código do Feira:</p>
